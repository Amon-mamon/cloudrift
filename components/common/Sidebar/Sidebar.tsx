      ...
      <div className="relative p-2">
        {collapsed ? (
          ...
          <div className="bg-white/3 border border-white/8 rounded-xl p-3.5 hover:border-white/12 transition-all">
            ...
            <button className="w-full text-[10px] font-medium text-blue-400 hover:text-blue-300 bg-blue-500/8 hover:bg-blue-500/[0.14] border border-blue-500/2 rounded-lg py-1.5 transition-all">
              Upgrade storage ↑
            </button>
          </div>
        )}
